...
Historial completo de fases, releases y hallazgos en [`docs/STATUS.md`](docs/STATUS.md) (las entradas nuevas se añaden ARRIBA allí; aquí solo las 3-4 más recientes, comprimidas). Los defectos D-NN están catalogados en [`docs/references/indice-defectos.md`](docs/references/indice-defectos.md) — 52 a fecha 2026-08-23, con guarda mecánica.
...
| [`docs/tasks/`](docs/tasks/) | Planes activos: `plan-gate-locators-medidos.md` (la regla dura del walker en el camino del planner), `probar-kernel-v2-k0.md`, `todo.md` |
