...
- **A/B del FD literal · ParaBank sellado, y D56 (2026-08-24)** — primera medición reproducible del efecto: **2/11 sin citar vs 12/12 citado**, y los 9 bloqueos son TODOS de idioma del hint, **cero fallos de escalera** (la predicción que podía tumbar tres sitios de conclusiones). Salió D56: un verde sin poder discriminante — la postcondición del logout ya era cierta en la pantalla de entrada. Detalle y límites: [`docs/findings/ab-fd-literal-parabank-sellado.md`](docs/findings/ab-fd-literal-parabank-sellado.md).
